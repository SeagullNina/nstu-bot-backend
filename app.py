...
BOT_CONFIG = {
    'intents': {
        ...
        'help': {
            'examples': [
                'Справка', 'Помощь', 'Все возможности'
            ],
            'responses': ['Чтобы получить список всех направлений, введите Все направления. Чтобы получить список всех факультетов, введите Все факультеты. Вы также можете ввести интересующее Вас направление или факультет, чтобы узнать о нем больше. Чтобы узнать о минимальных баллах, введите Минимальные баллы. Чтобы узнать о подготовительных курсах, введите Подгоотовительные курсы. Чтобы узнать о правилах приёма, введите Правила приёма. Чтобы узнать о необходимых документах для поступления, введите Документы. Чтобы пройти тест на профориентацию, введите Тест.']
        },
        'bye': {
        ...
        'lhot_places': {
            'examples': ['Что такое льготные места', 'Поступление вне конкурса', 'Льготы'],
            'responses': [
